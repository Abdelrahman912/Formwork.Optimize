...
namespace FormworkOptimize.App.ViewModels
{
    public class FormworkElementsIncludedInGeneticViewModel:ViewModelBase
    {
        ...
        public Validation<GeneticIncludedElements> IncludedElementsService()
        {
            ...
            return new GeneticIncludedElements(includedPlywoods, includedBeamSections,includedLedgers,includedVerticals,includedTubes, includedSteelTypes,includedProps, includedShoreBracing,includedFrameTypes);
        }
