...
namespace FormworkOptimize.Core.Constants
{
    public static class Database
    {
        ...
        private static readonly List<BeamLengths> _beamLengths = new List<BeamLengths>()
        {
            ...
            new BeamLengths(BeamSectionName.TIMBER_2X4, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.TIMBER_2X5, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.TIMBER_2X6, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.TIMBER_2X8, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.TIMBER_3X3, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.TIMBER_3X5, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.TIMBER_3X6, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.TIMBER_4X4, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.DOUBLE_TIMBER_H20, new List<double>(){180, 190, 250, 290, 330, 360, 390, 450, 490, 590 }),
            new BeamLengths(BeamSectionName.DOUBLE_TIMBER_2X5, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.DOUBLE_TIMBER_2X6, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.DOUBLE_TIMBER_2X8, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
            new BeamLengths(BeamSectionName.DOUBLE_TIMBER_3X6, new List<double>(){120,150,180,210,240,270,300,330,360,390,420,450 }),
