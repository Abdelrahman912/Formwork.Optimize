...
namespace FormworkOptimize.Core.Constants
{
    public static class Database
    {
        ...
        {
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.BETOFILM_18MM , Price = 250 , UnitCost = UnitCostMeasure.AREA,NumberOfUses = 10 },
           new PurchaseFormworkElementCost(){Name = FromworkCostElements.COFIFORM_PLUS_1705MM , Price = 300 , UnitCost = UnitCostMeasure.AREA , NumberOfUses = 10 },
           new PurchaseFormworkElementCost(){Name = FromworkCostElements.DOUGLAS_FIR_19MM , Price = 350 , UnitCost = UnitCostMeasure.AREA , NumberOfUses = 10},
           new PurchaseFormworkElementCost(){Name = FromworkCostElements.WISAFORM_BIRCH_18MM , Price = 400 , UnitCost = UnitCostMeasure.AREA,NumberOfUses = 10},

           new RentFormworkElementCost(){Name = FromworkCostElements.ACROW_BEAM_S12 , Price = 10 , UnitCost = UnitCostMeasure.LENGTH},
           new RentFormworkElementCost(){Name = FromworkCostElements.DOUBLE_ACROW_BEAM_S12 , Price = 20 , UnitCost = UnitCostMeasure.LENGTH},
           new RentFormworkElementCost(){Name = FromworkCostElements.ALUMINUM_BEAM , Price = 7 , UnitCost = UnitCostMeasure.LENGTH},
          new RentFormworkElementCost(){Name = FromworkCostElements.DOUBLE_ALUMINUM_BEAM , Price = 14 , UnitCost = UnitCostMeasure.LENGTH},
           new RentFormworkElementCost(){Name = FromworkCostElements.S_BEAM_12 , Price = 10 , UnitCost = UnitCostMeasure.LENGTH},
           new RentFormworkElementCost(){Name = FromworkCostElements.TIMBER_H20 , Price = 7.5 , UnitCost = UnitCostMeasure.LENGTH},

            new PurchaseFormworkElementCost(){Name = FromworkCostElements.TIMBER_2X4 , Price = 42.5 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.TIMBER_2X5 , Price = 53.13 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.TIMBER_2X6 , Price = 63.75 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.TIMBER_2X8 , Price = 85 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.TIMBER_3X3 , Price = 47.81 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.TIMBER_3X5 , Price = 79.69 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.TIMBER_3X6 , Price = 95.63 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.TIMBER_4X4 , Price = 85 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},


           new RentFormworkElementCost(){Name = FromworkCostElements.DOUBLE_TIMBER_H20 , Price = 15 , UnitCost = UnitCostMeasure.LENGTH},

           new PurchaseFormworkElementCost(){Name = FromworkCostElements.DOUBLE_TIMBER_2X5 , Price = 106.25 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.DOUBLE_TIMBER_2X6 , Price = 127.5 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.DOUBLE_TIMBER_3X6 , Price = 191.25 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},
            new PurchaseFormworkElementCost(){Name = FromworkCostElements.DOUBLE_TIMBER_2X8 , Price = 170 , UnitCost = UnitCostMeasure.LENGTH,NumberOfUses=10},


            new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_0050M_STEEL37 , Price = 2.3 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_100M_STEEL37 , Price = 4.1 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_1050M_STEEL37 , Price = 6.15 , UnitCost = UnitCostMeasure.NUMBER},
          new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_200M_STEEL37 , Price = 7.89 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_2050M_STEEL37 , Price = 9.79 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_300M_STEEL37 , Price = 11.4 , UnitCost = UnitCostMeasure.NUMBER},

            new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_0050M_STEEL52 , Price = 2.99 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_100M_STEEL52 , Price = 5.33 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_1050M_STEEL52 , Price = 8 , UnitCost = UnitCostMeasure.NUMBER},
          new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_200M_STEEL52 , Price = 10.26 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_2050M_STEEL52 , Price = 12.73 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_VERTICAL_300M_STEEL52 , Price = 14.82 , UnitCost = UnitCostMeasure.NUMBER},


           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_0060M_STEEL37 , Price = 2.12 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_0090M_STEEL37 , Price = 2.46 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_1020M_STEEL37 , Price = 2.93 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_1050M_STEEL37 , Price = 3.68 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_1080M_STEEL37 , Price = 4.41 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_2010M_STEEL37 , Price = 5.12 , UnitCost = UnitCostMeasure.NUMBER},
            new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_2040M_STEEL37 , Price = 5.84 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_2070M_STEEL37 , Price = 6.56 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_300M_STEEL37 , Price = 7.12 , UnitCost = UnitCostMeasure.NUMBER},


           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_0060M_STEEL52 , Price = 2.76 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_0090M_STEEL52 , Price = 3.2 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_1020M_STEEL52 , Price = 3.81 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_1050M_STEEL52 , Price = 4.78 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_1080M_STEEL52 , Price = 5.73 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_2010M_STEEL52 , Price = 6.66 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_2040M_STEEL52 , Price = 7.59 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_2070M_STEEL52 , Price = 8.53 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CUPLOCK_LEDGER_300M_STEEL52 , Price = 9.26 , UnitCost = UnitCostMeasure.NUMBER},


           new RentFormworkElementCost(){Name = FromworkCostElements.U_HEAD_JACK_SOLID , Price = 5.3 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.POST_HEAD_JACK_SOLID , Price = 4.26 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.ROUND_SPIGOT , Price = 0.38 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SPRING_CLIP , Price = 0.03 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.RIVET_PIN_16MM_L9CM , Price = 0.38 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.PRESSED_PROP_SWIVEL_COUPLER , Price = 1.16 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.PROP_LEG , Price = 4.52 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.U_HEAD_FOR_PROPS , Price = 3.5 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SHOREBRACE_CONNECTOR , Price = 0.5 , UnitCost = UnitCostMeasure.NUMBER},


           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_100M , Price = 1.32 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_1050M , Price = 2 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_200M , Price = 2.63 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_2050M , Price = 3.29 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_300M , Price = 3.95 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_3050M , Price = 4.61 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_400M , Price = 5.27 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_4050M , Price = 5.93 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_500M , Price = 6.58 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.SCAFFOLDING_TUBE_600M , Price = 7.9 , UnitCost = UnitCostMeasure.NUMBER},

            new RentFormworkElementCost(){Name = FromworkCostElements.ACROW_PROP_D40 , Price = 6.28 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.ACROW_PROP_D45 , Price = 6.79 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.ACROW_PROP_E30 , Price = 4.61 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.ACROW_PROP_E35 , Price = 6.05 , UnitCost = UnitCostMeasure.NUMBER},

            new RentFormworkElementCost(){Name = FromworkCostElements.SHOREBRACE_FRAME , Price = 16.04 , UnitCost = UnitCostMeasure.NUMBER},
            new RentFormworkElementCost(){Name = FromworkCostElements.SHOREBRACE_TELESCOPIC_FRAME , Price = 13.83 , UnitCost = UnitCostMeasure.NUMBER},


            new RentFormworkElementCost(){Name = FromworkCostElements.CROSS_BRACE_0090M , Price = 3.65 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CROSS_BRACE_1020 , Price = 4.1 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CROSS_BRACE_1050 , Price = 4.4 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CROSS_BRACE_1080 , Price = 4.9 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CROSS_BRACE_2010 , Price = 5.3 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CROSS_BRACE_2040 , Price = 5.65 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CROSS_BRACE_2070 , Price = 6.12 , UnitCost = UnitCostMeasure.NUMBER},
           new RentFormworkElementCost(){Name = FromworkCostElements.CROSS_BRACE_300 , Price = 6.54 , UnitCost = UnitCostMeasure.NUMBER},
