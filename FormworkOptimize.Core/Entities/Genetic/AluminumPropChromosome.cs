...
{
    public class AluminumPropChromosome : BinaryChromosomeBase
    {
        ...
        #region Properties
        public AluPropDesignInput AluminumPropDesignInput { get; set; }
        ...
        public AluminumPropChromosome(double minValue, double maxValue, int fractionDigits)
        ...
        /// <param name="fractionDigits">Decimals.</param>
        public AluminumPropChromosome(double minValue, double maxValue, int totalBits, int fractionDigits)
        ...
        public AluminumPropChromosome(double[] minValue, double[] maxValue, int[] totalBits, int[] fractionDigits, double[] geneValues)
            : base(totalBits.Sum())
        {
            m_minValue = minValue;
            m_maxValue = maxValue;
        ...
        {
            return new AluminumPropChromosome(m_minValue, m_maxValue, m_totalBits, m_fractionDigits);
        }
