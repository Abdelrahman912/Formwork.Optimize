...
{
    public class CuplockChromosome : BinaryChromosomeBase
    {
        ...
        public CuplockDesignInput CuplockDesignInput { get; set; }
        ...
        public CuplockChromosome(double minValue, double maxValue, int fractionDigits)
        ...
        /// <param name="fractionDigits">Decimals.</param>
        public CuplockChromosome(double minValue, double maxValue, int totalBits, int fractionDigits)
        ...
        public CuplockChromosome(double[] minValue, double[] maxValue, int[] totalBits, int[] fractionDigits, double[] geneValues)
            : base(totalBits.Sum())
        {
            m_minValue = minValue;
            m_maxValue = maxValue;
        ...
        {
            return new CuplockChromosome(m_minValue, m_maxValue, m_totalBits, m_fractionDigits);
        }
