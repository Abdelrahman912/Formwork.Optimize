...
{
    public class EuropeanPropChromosome : BinaryChromosomeBase
    {
        ...
        public EuropeanPropDesignInput EuropeanPropDesignInput { get; set; }
        ...
        public EuropeanPropChromosome(double minValue, double maxValue, int fractionDigits)
        ...
        /// <param name="fractionDigits">Decimals.</param>
        public EuropeanPropChromosome(double minValue, double maxValue, int totalBits, int fractionDigits)
        ...
        public EuropeanPropChromosome(double[] minValue, double[] maxValue, int[] totalBits, int[] fractionDigits, double[] geneValues)
            : base(totalBits.Sum())
        {
            m_minValue = minValue;
            m_maxValue = maxValue;
        ...
        {
            return new EuropeanPropChromosome(m_minValue, m_maxValue, m_totalBits, m_fractionDigits);
        }
