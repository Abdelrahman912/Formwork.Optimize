...
{
    public class FrameChromosome : BinaryChromosomeBase
    {
        ...
        #region Properties
        public FrameDesignInput FrameDesignInput { get; set; }
        ...
        public FrameChromosome(double minValue, double maxValue, int fractionDigits)
        ...
        /// <param name="fractionDigits">Decimals.</param>
        public FrameChromosome(double minValue, double maxValue, int totalBits, int fractionDigits)
        ...
        public FrameChromosome(double[] minValue, double[] maxValue, int[] totalBits, int[] fractionDigits, double[] geneValues)
            : base(totalBits.Sum())
        {
            m_minValue = minValue;
            m_maxValue = maxValue;
        ...
        {
            return new FrameChromosome(m_minValue, m_maxValue, m_totalBits, m_fractionDigits);
        }
